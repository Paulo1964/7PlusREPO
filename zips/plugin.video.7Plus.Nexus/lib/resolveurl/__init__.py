...
try:
    home = xbmcvfs.translatePath(xbmcaddon.Addon('plugin.video.7Plus.Nexus').getAddonInfo('path').decode('utf-8'))
except:
    home = xbmcvfs.translatePath(xbmcaddon.Addon('plugin.video.7Plus.Nexus').getAddonInfo('path'))
